	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			finalText : 'スペースキーを押して課題を完了してください。', 
			...
			instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'ここでは<b>E</b>キーが<font color="#336600">leftCategory</font>と<font color="#0000ff">leftAttribute</font>の両方に対応します。<br/>' +
				'そして<b>I</b>キーが<font color="#336600">rightCategory</font>と<font color="#0000ff">rightAttribute</font>の両方に対応します。<br/>' +
		...
		**/
		...
		scorer.addSettings('compute',{
			...
			errorLatency : {use:"false", penalty:600, useForSTD:true},
